...
<html lang="en">
  <head>
    <title>අපේ ICT පංතිය | Verify Account</title>
    <meta charset="utf-8">
...
<div>
  ...
  <form class="modal-content animate" action="send_mail.php" method="post">
    ...
    <div class="container">
      ...
      <input type="text" value="<?php echo $mail_to; ?>" name="mail_to" required>

    
      <input type="hidden" value="<?php echo $mail_msg; ?>" name="mail_msg" required>

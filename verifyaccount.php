...
if(isset($_SESSION['errorVerify'])) {
    ...
    echo '<script>';
    echo  'alert("Incorrect Email or OTP..Retry")';
    echo '</script>';
} 
...
<div>
  ...
  <form class="modal-content animate" action="checkotp.php" method="post">
    ...
    <div class="container">
      ...
      <label for="uname"><b>OTP Code</b></label>
      <input type="text" placeholder="Enter otp code" name="otpCode" required>
